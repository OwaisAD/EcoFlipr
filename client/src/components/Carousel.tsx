...
const Carousel = ({ saleOffers, rowID }: CarouselInput) => {
  const slideLeft = () => {
  ...
  return (
    <>
      <div className="relative flex bg-white  border-gray-200 border rounded-xl group items-center lg:mx-0 md:mx-0 sm:mx-4 mx-6">
        <MdChevronLeft
          size={26}
